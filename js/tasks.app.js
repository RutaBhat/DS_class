var tasksApp = new Vue({
  ...
  methods: {
    handleWorkForm(e) {
      ...
      //TODO: Append result
      this.work.push(JSON.parse(s));//making a copy fo the object and adding it to work data array
  ...
  created () {
    ...
    const taskId = url.searchParams.get("taskId");//where the task id is out of url
